...
function renderAssetsTable() {
  ...
  filtered.forEach(asset => {
    ...
    tr.innerHTML = `
      ...
      <td class="py-3 px-2 pr-3 text-center row-actions sticky right-0 lg:static bg-white lg:bg-transparent z-10 lg:z-auto border-l lg:border-l-0 border-[rgba(190,201,195,0.3)] shadow-[-4px_0_8px_rgba(0,0,0,0.03)] lg:shadow-none">
