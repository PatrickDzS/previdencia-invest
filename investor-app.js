    ...
    headerSearch.addEventListener('input', (e) => {
      ...
      filtered.forEach(asset => {
        ...
        tr.innerHTML = `
          ...
          <td class="py-3 px-3 text-center row-actions"><div class="flex items-center justify-center gap-1.5 flex-nowrap pr-1"><button onclick="event.stopPropagation(); openRaioXForTicker('${asset.ticker}')" class="inline-flex items-center justify-center w-7 h-7 rounded-md bg-[rgba(6,182,212,0.08)] hover:bg-[rgba(6,182,212,0.12)] text-[#0891b2] border border-[rgba(6,182,212,0.15)] transition-colors duration-150 active:scale-95 shrink-0 lg:w-auto lg:h-auto lg:px-2.5 lg:py-1 lg:gap-1"><i data-lucide="microscope" class="shrink-0" style="width:12px;height:12px"></i> <span class="hidden lg:inline text-[11px] font-bold">Raio-X</span></button><button onclick="event.stopPropagation(); openEditAsset('${asset.ticker}')" class="inline-flex items-center justify-center gap-1 px-2.5 py-1 rounded-md text-[11px] font-bold bg-[#00513f] hover:bg-[#006b55] text-white shadow-sm border border-[#00513f] transition-all duration-150 active:scale-95 shrink-0"><i data-lucide="pencil" class="shrink-0" style="width:11px;height:11px"></i> <span>Editar</span></button><button onclick="event.stopPropagation(); removeAssetFromPortfolio('${asset.ticker}')" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-white hover:bg-[#ffdad6] text-[#3e4945] hover:text-[#ba1a1a] border border-[rgba(190,201,195,0.4)] hover:border-[#ba1a1a]/20 transition-colors duration-150 active:scale-95 shrink-0"><i data-lucide="trash-2" class="shrink-0" style="width:13px;height:13px"></i></button></div></td>`;
